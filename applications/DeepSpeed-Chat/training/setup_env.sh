...
if [ "$model" = "opt-66b" ] && [ "$step" = "1" ]; then
    ...
    export OUTPUT=./output/opt-66b_step1
    export ZERO_STAGE=3
    export MODEL_NAME=facebook/opt-66b
    export MODEL_PATH=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-66b/snapshots/7259969061237fe940036d22bea0fd349e4485e9
    export DATA_OUTPUT_PATH=/home/ubuntu/shared/.cache/data_files/opt-66b_step1
elif [ "$model" = "opt-13b" ] && [ "$step" = "1" ]; then
    export SCRIPT_PATH=/home/ubuntu/shared/DeepSpeedExamples/applications/DeepSpeed-Chat/training/step1_supervised_finetuning
    export OUTPUT=./output/opt-13b_step1
    export ZERO_STAGE=3
    export MODEL_NAME=facebook/opt-13b
    export MODEL_PATH=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-13b/snapshots/e515202d1e7750da62d245fbccb2723b9c1790f5
    ...
    export OUTPUT=./output/opt-13b_step3
    export ACTOR_ZERO_STAGE=3
    export CRITIC_ZERO_STAGE=3
    export ACTOR_MODEL_PATH=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-13b/snapshots/e515202d1e7750da62d245fbccb2723b9c1790f5
    export CRITIC_MODEL_PATH=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-350m/snapshots/cb32f77e905cccbca1d970436fb0f5e6b58ee3c5
    ...
    export OUTPUT=./output/opt-350m_step2
    export ZERO_STAGE=0
    export MODEL_NAME=facebook/opt-350m
    export MODEL_PATH=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-350m/snapshots/cb32f77e905cccbca1d970436fb0f5e6b58ee3c5
