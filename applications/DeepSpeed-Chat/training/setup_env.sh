...
if [ "$model" = "opt-66b" ] && [ "$step" = "1" ]; then
    ...
    export CRITIC_MODEL_CACHE=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-350m/snapshots/08ab08cc4b72ff5593870b5d527cf4230323703c
    ...
    export MODEL_CACHE=/home/ubuntu/shared/.cache/huggingface/transformers/models--facebook--opt-350m/snapshots/08ab08cc4b72ff5593870b5d527cf4230323703c
